...
if __name__ == "__main__":
    ...
    # Run ROUGE and BERTScore evaluation for entity labels
    gold_labels = {x["id"]: [y["entity"] for y in x["entity_labels"]] for x in gold_data}
    pred_labels = {x["id"]: x["labels"] for x in pred_data}
    run_snippet_eval(pred_labels, gold_labels, args.debug)