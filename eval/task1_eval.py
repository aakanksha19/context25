...
def run_eval(pred_labels, gold_labels, claim_figures_tables, debug):
    ranks_to_eval = [3, 5]
    ...
    for claim_id in pred_labels:
        ...
        for rank in ranks_to_eval:
            ...
            for image_id in claim_figures_tables[claim_id]:
...
if __name__ == "__main__":
    ...
    claim_figures_tables = {x["id"]: x["figures_tables"] for x in gold_data}
    ...
    run_eval(pred_labels, gold_labels, claim_figures_tables, args.debug)